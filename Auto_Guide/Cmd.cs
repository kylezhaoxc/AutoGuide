...
namespace Auto_Guide
{
    public class Cmd
    {
        ...
        public static readonly byte[] turn_right = new byte[] {
            ...
            0x08, 0x01, 0x00, 0x53, 0x50};

        public static readonly byte[] turn_left = new byte[] {
            0x08, 0x01, 0x00, 0x41, 0x32,
            0x08, 0x01, 0x00, 0x53, 0xD0};
        public static readonly byte[] turn_right_faster = new byte[]
        {
             0x08, 0x01, 0x00, 0x41,0x32,
            0x08, 0x01, 0x00, 0x51, 0x50,
            0x08, 0x01, 0x00, 0x52, 0x50,
            0x08, 0x01, 0x00, 0x53, 0x50};
        public static readonly byte[] turn_left_faster = new byte[]{
            0x08, 0x01, 0x00, 0x41, 0x32,
            0x08, 0x01, 0x00, 0x51, 0xD0,
            0x08, 0x01, 0x00, 0x52, 0xD0,
            0x08, 0x01, 0x00, 0x53, 0xD0};
